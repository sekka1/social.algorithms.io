...
ini_set('error_reporting', E_ALL);
	...
	try{
		...
		$account_totals = $twitter->api()->profile( '~/connections?format=json', 'get' );
print_r($account_totals);
		// print recived stats 
