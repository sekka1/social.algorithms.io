...
namespace AlgorithmsIO\Node\Import{
    ...
    class CreateNodeBatchFilesBase{
        ...
        public function __construct() {
            ...
            $this->mysqlPort = null;
            $this->mysqlUser = 'akkadian';
            $this->mysqlPassword = 'akkadian1298';
            
            // Get data from MySQL
            $this->mysql = new \AlgorithmsIO\Utilities\MySQL();
            $this->mysql->setConnection('localhost', null, 'akkadian', 'akkadian1298');
        ...
        private function isNodeInTable($guid){
            $sql = "SELECT * FROM ".$this->tableNameNode." WHERE nodeGUID='".$guid."'";
