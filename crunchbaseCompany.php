...
$crunchbaseGraphModel = new \AlgorithmsIO\GraphModels\CrunchBaseCompany();
...
$crunchbase_users = '[{"first_name":"Kevin","last_name":"Flaherty","permalink":"eharmony"}]';
//$crunchbase_users = file_get_contents('data/crunchbase_company_062513.json');
	...
	print_r($aUser);
                ...
                /*
                system('echo "Starting\n" > /tmp/adding_crunchbaseCompany.txt');
